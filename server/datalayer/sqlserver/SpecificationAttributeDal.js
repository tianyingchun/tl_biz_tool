...
function SpecificationAttributeDal() {
    ...
    this.addOrUpdateProductSpecificationAttributesMapping = function(productSpecificationAttributeMapping) {
        ...
        var insertRecordSql = "INSERT INTO Product_SpecificationAttribute_Mapping (ProductId, SpecificationAttributeOptionId,  CustomValue, AllowFiltering, AttributeTypeId,  ShowOnProductPage, DisplayOrder ) VALUES  ({0},{1},{2},{3},{4},{5},{6})";
